...
public class GLShaderLog {
	...
	public String getShaderTypeString(){
		switch(type){
		case GL2ES3.GL_VERTEX_SHADER: return "GL_VERTEX_SHADER ("+type+")";
		case GL2ES3.GL_FRAGMENT_SHADER: return "GL_FRAGMENT_SHADER ("+type+")";
		case GL3ES3.GL_GEOMETRY_SHADER: return "GL_GEOMETRY_SHADER ("+type+")";
		case GL3ES3.GL_COMPUTE_SHADER: return "GL_COMPUTE_SHADER ("+type+")";
		case GL3ES3.GL_TESS_CONTROL_SHADER: return "GL_TESS_CONTROL_SHADER ("+type+")";
		case GL3ES3.GL_TESS_EVALUATION_SHADER: return "GL_TESS_EVALUATION_SHADER ("+type+")";
		default: return "UNKNOWN_SHADER_TYPE ("+type+")";
		}
	}
